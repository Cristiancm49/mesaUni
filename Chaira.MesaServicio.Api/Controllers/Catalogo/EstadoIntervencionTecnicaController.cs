...
{
    [ApiController]
    [Route("api/catalogo/estados-intervencion")]
    [Tags("EstadoIntervencionTecnica")]
    [Authorize(Roles = AppRoles.Todos)]
    public class EstadoIntervencionTecnicaController : ControllerBase
    {
        private readonly IEstadoIntervencionTecnicaService _service;
        public EstadoIntervencionTecnicaController(IEstadoIntervencionTecnicaService service) => _service = service;
        ...
        public async Task<IActionResult> Crear([FromBody] EstadoIntervencionTecnicaCreateDto dto)
        {
        ...
        [HttpPut("{id:long}")]
        [Authorize(Roles = AppRoles.Administrador)]
        public async Task<IActionResult> Actualizar(long id, [FromBody] EstadoIntervencionTecnicaUpdateDto dto)
        {
