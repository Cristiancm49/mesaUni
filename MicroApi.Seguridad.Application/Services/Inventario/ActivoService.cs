    ...
    public class ActivoService : GenericService<Activo, ActivoDto, ActivoCreateDto, ActivoUpdateDto>, IActivoService
    {
        ...
        public override async Task<ApiResponseDto<ActivoDto>> UpdateAsync(long id, ActivoUpdateDto updateDto)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    errorMessage = "No se puede actualizar el activo porque la referencia no existe (categoría, estado, inventario, ubicación o responsable no válido)";
                }
                ...
                {
                    errorMessage = "Ya existe un activo con el mismo código patrimonial o serie";
                }
