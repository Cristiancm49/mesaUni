...
namespace Chaira.MesaServicio.Application.Services.Auth
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<LoginResponseDto> LoginAsync(LoginDto loginDto)
        {
            try
            {
                ...
                // NOTA: En producciÃ³n deberÃ­as validar el password con hash
                // Por ahora, para desarrollo, aceptamos cualquier password no vacÃ­o
