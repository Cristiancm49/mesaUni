...
namespace MicroApi.Seguridad.Api.Controllers.Catalogo
{
    ...
    public class EstadoCasoController : ControllerBase
    {
        ...
        public EstadoCasoController(IEstadoCasoService service) => _service = service;
        ...
        public async Task<IActionResult> Crear([FromBody] EstadoCasoCreateDto dto)
        {
        ...
        [HttpPut("{id:long}")]
        [Authorize(Roles = AppRoles.Administrador)]
        public async Task<IActionResult> Actualizar(long id, [FromBody] EstadoCasoUpdateDto dto)
        {
